...
#include "../ADT/stackt/stackt.c"
#include "../ADT/mesinkata/mesinkata.c"
#include "../ADT/mesinkar/mesinkar.c"
#include "../ADT/jam/jam.c"
#include "../ADT/wahana/wahana.c"
#include "../ADT/bintree/bintree.c"
#include "../ADT/listrek/listrek.c"
#include "../ADT/arraypos/arraypos.c"
#include "../ADT/prioqueuechar/prioqueuechar.c"
